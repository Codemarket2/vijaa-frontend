...
export default function ButtonAppBar({ title }) {
  ...
  return (
    <div className={classes.root}>
      ...
      <StyledNav position="fixed" className={classes.nav}>
        <Toolbar>
          <StyledHeader className="d-none d-md-block d-lg-block" variant="h6">
            Drreamz
          </StyledHeader>
          <StyledHeader className="d-block d-md-none d-lg-none" variant="h6">
            {title ? title : 'Drreamz'}
          </StyledHeader>
          <div className="d-none d-md-block">
            <IconButton onClick={() => router.push('/coachinbox')}>
              <InboxIcon />
            </IconButton>
            ...
            <IconButton onClick={() => router.push('/videoConference')}>
              <GroupIcon />
            </IconButton>
            <IconButton>
